...
html_theme_options = {
    ...
    'github_repo': 'inspire-crawler',
    'github_button': False,
    'github_banner': True,
    'show_powered_by': False,
    'extra_nav_links': {
        'inspire-crawler@GitHub': 'http://github.com/inspirehep/inspire-crawler',
        'inspire-crawler@PyPI': 'http://pypi.python.org/pypi/inspire-crawler/',
    }
}
...
htmlhelp_basename = 'inspire-crawler_namedoc'
...
latex_documents = [
  (master_doc, 'inspire-crawler.tex', u'inspire-crawler Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'inspire-crawler', u'inspire-crawler Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'inspire-crawler', u'inspire-crawler Documentation',
   author, 'inspire-crawler', 'Crawler integration with INSPIRE-HEP.',
   'Miscellaneous'),
]
